...
\begin{enumerate}
	...
	\begin{enumerate}[1.]
		...
		\begin{enumerate}[1.]
			...
			\item Actualiz@am valoarea Q a st@arii curente @in func@tie de noile informa@tii: $$Q^{\pi}(s, a) \leftarrow Q^{\pi}(s, a) + \alpha \left[ r(s,a) + \gamma max_{a^{\prime}} Q^{\pi}(s^{\prime}, a^{\prime}) - Q^{\pi}(s, a) \right] $$
