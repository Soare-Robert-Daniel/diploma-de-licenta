...
Aplica@tia const@a @in antrenarea unor agen@tii care s@a parcurg@a un traseu de tip labirint definit @intr-un mediu 2-dimensional.

Labirintul este compus din mai multe celule, unele dintre find reprezentate de obstacole.

Agentul are sarcina s@a ajung@a la ie@sire @si s@a evite obstacolele @intr-un num@ar minim de pa@si. 
...
Simulatorul actioneaz@a ca o interfa@ta @intre agent @si mediul reprezentat de labirint prin clasa Board.
