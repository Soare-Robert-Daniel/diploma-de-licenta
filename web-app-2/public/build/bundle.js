...
var app = (function () {
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	let { onClick = () => alert("Action was not set!") } = $$props;
    	let { variant = "default" } = $$props;
    	const writable_props = ["onClick", "variant"];
    	...
    	$$self.$capture_state = () => ({ onClick, variant });
    	...
    	return [onClick, variant, $$scope, slots];
    }

    class Button extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { onClick: 0, variant: 1 });
    ...
    /* src/Sidebare.svelte generated by Svelte v3.37.0 */
    const file$3 = "src/Sidebare.svelte";
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "option svelte-3vw9p5");
    			add_location(div0, file$3, 5, 4, 104);
    			attr_dev(div1, "class", "sidebar-form svelte-3vw9p5");
    			add_location(div1, file$3, 4, 0, 73);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	let { $$slots: slots = {}, $$scope } = $$props;
    	validate_slots("Sidebare", slots, []);
    	const writable_props = [];

    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Sidebare> was created with unknown prop '${key}'`);
    	});
    ...
    class Sidebare extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    ...
    var SceneContext = (function (_super) {
        ...
        SceneContext.prototype._fillPattern = function (shape) {
            var fillPatternX = shape.getFillPatternX(), fillPatternY = shape.getFillPatternY(), fillPatternRotation = Global.Konva.getAngle(shape.getFillPatternRotation()), fillPatternOffsetX = shape.getFillPatternOffsetX(), fillPatternOffsetY = shape.getFillPatternOffsetY(); shape.getFillPatternScaleX(); shape.getFillPatternScaleY();
    ...
    class BoardUI {
        ...
        constructor(board, stage) {
            ...
            this.mapLayer = new lib.Layer();
            this.valueLayer = new lib.Layer();
            this.playerLayer = new lib.Layer();
            this.pathLayer = new lib.Layer();
            ...
            this.board.board.forEach((row, rowIdx) => {
                row.forEach((cellInfo, colIdx) => {
                    ...
                    if (cellInfo.cellType === 'empty') {
                        ...
                        this.playerCell = new lib.Circle({
                            id: 'player',
    ...
    function createBordControlBusEvent() {
        ...
        return {
            ...
            addEvent: (eventName, payload) => {
                update(s => [...s, { eventName, id: v4(), payload }]);
            },
    ...
    const boardControlEvents = createBordControlBusEvent();

    const boardControlState = writable({
        movePlayer: false,
        addObstacle: false
    });

    /* src/Board.svelte generated by Svelte v3.37.0 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container svelte-h0eo2t");
    			add_location(div, file$2, 66, 0, 2007);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	component_subscribe($$self, boardControlEvents, $$value => $$invalidate(0, $boardControlEvents = $$value));
    	validate_store(boardControlState, "boardControlState");
    	component_subscribe($$self, boardControlState, $$value => $$invalidate(1, $boardControlState = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
     ...
     */
    	...
    	onMount(() => {
    		...
    		stage.on("click", () => {
    			...
    			const [posX, posY] = [Math.floor(x / boardUI.cellWidth), Math.floor(y / boardUI.cellHeight)];
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("boardUI" in $$props) boardUI = $$props.boardUI;
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$boardControlEvents, $boardControlState*/ 3) {
    			console.log($boardControlEvents, $boardControlState);
    		}

    		if ($$self.$$.dirty & /*$boardControlEvents*/ 1) {
    	...
    	return [$boardControlEvents, $boardControlState];
    }
    ...
    // (14:8) <Button             onClick={() =>                 boardControlEvents.addEvent("move", { action: "UP" })}             >
    function create_default_slot_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(14:8) <Button             onClick={() =>                 boardControlEvents.addEvent(\\\"move\\\", { action: \\\"UP\\\" })}             >",
    		ctx
    	});
    ...
    // (19:8) <Button             onClick={() =>                 boardControlEvents.addEvent("move", { action: "DOWN" })}             >
    function create_default_slot_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(19:8) <Button             onClick={() =>                 boardControlEvents.addEvent(\\\"move\\\", { action: \\\"DOWN\\\" })}             >",
    		ctx
    	});
    ...
    // (24:8) <Button             onClick={() =>                 boardControlEvents.addEvent("move", { action: "LEFT" })}             >
    function create_default_slot_2(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(24:8) <Button             onClick={() =>                 boardControlEvents.addEvent(\\\"move\\\", { action: \\\"LEFT\\\" })}             >",
    		ctx
    	});
    ...
    // (29:8) <Button             onClick={() =>                 boardControlEvents.addEvent("move", { action: "RIGHT" })}             >
    function create_default_slot_1(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(29:8) <Button             onClick={() =>                 boardControlEvents.addEvent(\\\"move\\\", { action: \\\"RIGHT\\\" })}             >",
    		ctx
    	});
    ...
    // (34:8) <Button onClick={() => boardControlEvents.addEvent("reset", 2)}             >
    function create_default_slot(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(34:8) <Button onClick={() => boardControlEvents.addEvent(\\\"reset\\\", 2)}             >",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input0, file$1, 38, 16, 1120);
    			add_location(label0, file$1, 37, 12, 1096);
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$1, 42, 16, 1259);
    			add_location(label1, file$1, 41, 12, 1235);
    			add_location(div0, file$1, 36, 8, 1078);
    			attr_dev(div1, "class", "commands svelte-inzl9q");
    			add_location(div1, file$1, 12, 4, 328);
    			attr_dev(div2, "class", "menu svelte-inzl9q");
    			add_location(div2, file$1, 11, 0, 305);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			input0.checked = /*movePlayer*/ ctx[0];
    			append_dev(label0, t5);
    			append_dev(div0, t6);
    			append_dev(div0, label1);
    			append_dev(label1, input1);
    			input1.checked = /*addObstacle*/ ctx[1];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*movePlayer*/ 1) {
    				input0.checked = /*movePlayer*/ ctx[0];
    			}

    			if (dirty & /*addObstacle*/ 2) {
    				input1.checked = /*addObstacle*/ ctx[1];
    			}
    		},
    		i: function intro(local) {
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	let $boardControlState;
    	validate_store(boardControlState, "boardControlState");
    	component_subscribe($$self, boardControlState, $$value => $$invalidate(9, $boardControlState = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<EditorMenu> was created with unknown prop '${key}'`);
    	});

    	const func = () => boardControlEvents.addEvent("move", { action: "UP" });
    	const func_1 = () => boardControlEvents.addEvent("move", { action: "DOWN" });
    	const func_2 = () => boardControlEvents.addEvent("move", { action: "LEFT" });
    	const func_3 = () => boardControlEvents.addEvent("move", { action: "RIGHT" });
    	const func_4 = () => boardControlEvents.addEvent("reset", 2);

    	function input0_change_handler() {
    		movePlayer = this.checked;
    		$$invalidate(0, movePlayer);
    	}

    	function input1_change_handler() {
    		addObstacle = this.checked;
    		$$invalidate(1, addObstacle);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		if ("movePlayer" in $$props) $$invalidate(0, movePlayer = $$props.movePlayer);
    		if ("addObstacle" in $$props) $$invalidate(1, addObstacle = $$props.addObstacle);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*movePlayer*/ 1) {
    			set_store_value(boardControlState, $boardControlState.movePlayer = movePlayer, $boardControlState);
    		}

    		if ($$self.$$.dirty & /*addObstacle*/ 2) {
    			set_store_value(boardControlState, $boardControlState.addObstacle = addObstacle, $boardControlState);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	let board;
    	let current;
    	sidebare = new Sidebare({ $$inline: true });
    	editormenu = new EditorMenu({ $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			main = element("main");
    			h1 = element("h1");
    			h1.textContent = "Învățarea automată pentru un agent într-un mediu 2D";
    			t1 = space();
    			p = element("p");
    			a0 = element("a");
    			a0.textContent = "Documentație framework";
    			t3 = text(" |\n\t\t");
    			a1 = element("a");
    			a1.textContent = "Librarie grafica";
    			t5 = text(" |\n\t\t");
    			a2 = element("a");
    			a2.textContent = "Lodash";
    			t7 = space();
    			div2 = element("div");
    			div0 = element("div");
    			create_component(sidebare.$$.fragment);
    			t8 = space();
    			div1 = element("div");
    			create_component(editormenu.$$.fragment);
    			t9 = space();
    			create_component(board.$$.fragment);
    			attr_dev(h1, "class", "svelte-wh7nd");
    			add_location(h1, file, 7, 1, 155);
    			attr_dev(a0, "href", "https://svelte.dev/tutorial");
    			add_location(a0, file, 9, 2, 223);
    			attr_dev(a1, "href", "https://konvajs.org/docs/index.html");
    			add_location(a1, file, 10, 2, 292);
    			attr_dev(a2, "href", "https://lodash.com/docs/4.17.15");
    			add_location(a2, file, 11, 2, 364);
    			add_location(p, file, 8, 1, 217);
    			attr_dev(div0, "class", "sidebar svelte-wh7nd");
    			add_location(div0, file, 15, 2, 447);
    			attr_dev(div1, "class", "editor svelte-wh7nd");
    			add_location(div1, file, 18, 2, 496);
    			attr_dev(div2, "class", "app svelte-wh7nd");
    			add_location(div2, file, 14, 1, 427);
    			attr_dev(main, "class", "svelte-wh7nd");
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(sidebare, div0, null);
    			append_dev(div2, t8);
    			append_dev(div2, div1);
    			mount_component(editormenu, div1, null);
    			append_dev(div1, t9);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(sidebare.$$.fragment, local);
    			transition_in(editormenu.$$.fragment, local);
    			transition_in(board.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(sidebare.$$.fragment, local);
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Sidebare, Board: Board_1, EditorMenu });
    	return [];
    }
